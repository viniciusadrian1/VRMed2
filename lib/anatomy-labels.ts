...
const LABEL_MAP: Record<string, string> = {
  ...
  // Ossos do crânio (modelo "exploding skull"). Nomes com lado ou "bone" para
  // não traduzir por engano palavras soltas de outros modelos.
  "frontal bone": "Osso frontal",
  "right parietal": "Osso parietal direito",
  "left parietal": "Osso parietal esquerdo",
  "right temporal": "Osso temporal direito",
  "left temporal": "Osso temporal esquerdo",
  "sphenoid bone": "Osso esfenoide",
  "ethmoid bone": "Osso etmoide",
  "right zygomatic": "Osso zigomático direito",
  "left zygomatic": "Osso zigomático esquerdo",
  "right maxilla": "Maxila direita",
  "left maxilla": "Maxila esquerda",
  "right nasal": "Osso nasal direito",
  "left nasal": "Osso nasal esquerdo",
  "right lacrimal": "Osso lacrimal direito",
  "left lacrimal": "Osso lacrimal esquerdo",
  "right palatine": "Osso palatino direito",
  "left palatine": "Osso palatino esquerdo",
  "inferior conchae": "Conchas nasais inferiores",
  vomer: "Vômer",
  mandible: "Mandíbula",
